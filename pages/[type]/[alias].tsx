  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={page && page.metaDescription}></meta>
        <meta property="og:title" content={page && page.metaTitle}></meta>
        <meta property="og:description" content={page && page.metaDescription}></meta>
